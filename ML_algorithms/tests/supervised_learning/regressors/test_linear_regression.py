...
print('\n')
train_loss1, valid_loss1, train_acc1, valid_acc1 = lr_obj.fitGD(
    xtrain=X_train,
    ytrain=y_train,
    xvalid=X_valid,
    yvalid=y_valid,
...
train_loss2, valid_loss2, train_acc2, valid_acc2 = lasso_obj.fitGD(
    xtrain=X_train,
    ytrain=y_train,
    xvalid=X_valid,
    yvalid=y_valid,
...
train_loss3, valid_loss3, train_acc3, valid_acc3 = ridge_obj.fitGD(
    xtrain=X_train,
    ytrain=y_train,
    xvalid=X_valid,
    yvalid=y_valid,
...
train_loss = degree_2.fitGD(xtrain=X_train,
                            ytrain=y_train,
                            num_epochs=275,
                            learn_rate=0.01,
                            ret_train_loss=True)
...
lasso_objd2.fitGD(xtrain=X_train,
                  ytrain=y_train,
                  num_epochs=275,
                  learn_rate=0.01)
...
ridge_objd2.fitGD(xtrain=X_train,
                  ytrain=y_train,
                  num_epochs=275,
                  learn_rate=0.01)

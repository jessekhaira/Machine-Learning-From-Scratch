...
class test(unittest.TestCase):
    def testBinaryUnregularized(self):
        ...
        # with 3 layers ~2.5. 
        MLP = MultiLayerPerceptron(typeSupervised="binary", numberInputFeatures = X_train.shape[0])
        ...
        train_loss, valid_loss, train_acc, valid_acc = MLP.fit(X_train, y_train, X_valid, y_valid, ret_train_loss=True, num_epochs=100, learn_rate=2.6)
    ...
    def testHighRegBinary(self):
        ...
        MLP1 = MultiLayerPerceptron(typeSupervised="binary", numberInputFeatures = X_train.shape[0], regularization="L1", regParameter=500)
        MLP2 = MultiLayerPerceptron(typeSupervised="binary", numberInputFeatures = X_train.shape[0], regularization="L2", regParameter=500)
        # 10 features learnt in first hidden layer w/ ReLU
        ...
        train_loss1, valid_loss1, train_acc1, valid_acc1 = MLP1.fit(X_train, y_train, X_valid, y_valid, ret_train_loss=True, num_epochs=10, learn_rate=2.6)
        ...
        train_loss2, valid_loss2, train_acc2, valid_acc2 = MLP2.fit(X_train, y_train, X_valid, y_valid, ret_train_loss=True, num_epochs=10, learn_rate=3)
    ...
    def testNormalRegBinary(self):
        ...
        MLP3 = MultiLayerPerceptron(typeSupervised="binary", numberInputFeatures = X_train.shape[0], regularization="L1", regParameter=0.01)
        MLP4 = MultiLayerPerceptron(typeSupervised="binary", numberInputFeatures = X_train.shape[0], regularization="L2", regParameter=0.01)
        ...
        train_loss3, valid_loss3, train_acc3, valid_acc3 = MLP3.fit(X_train, y_train, X_valid, y_valid, ret_train_loss=True, num_epochs=100, learn_rate=2.8)
        ...
        train_loss4, valid_loss4, train_acc4, valid_acc4 = MLP4.fit(X_train, y_train, X_valid, y_valid, ret_train_loss=True, num_epochs=100, learn_rate = 2.6)
    ...
    def testMultiClass(self):
        ...
        train_loss_sm, train_acc_sm= sm.fit(X, y, ret_train_loss=True, num_epochs=190, learn_rate=1)
        print(train_loss_sm)
        ...
        MLP6 = MultiLayerPerceptron(typeSupervised="multiclass", numberInputFeatures = 2)
        ...
        train_loss6, train_acc = MLP6.fit(xtrain = X, ytrain = y, num_epochs=1000, learn_rate=1,ret_train_loss=True)
        print(train_loss6)
        ...
        MLP7 = MultiLayerPerceptron(typeSupervised="multiclass", numberInputFeatures = 2, regularization="L2", regParameter=1e-3)
        # Learn 100 features in first hidden layer
        MLP7.add_layer(100, activationFunction = ReLU()) 
        # Output layer learn 3 features for softmax 
        MLP7.add_layer(3, activationFunction = Softmax(), isSoftmax=1)
        train_loss7, train_acc7= MLP7.fit(xtrain = X, ytrain = y, num_epochs=5000, learn_rate=1,ret_train_loss=True)
        print(train_loss7)
